...
-- ###################################################
---@source GTK4- https://docs.gtk.org/gtk4/running.html#environment-variables | GTK3- https://docs.gtk.org/gtk3/running.html#environment-variables | Hyprland: https://wiki.hypr.land/Configuring/Environment-variables/#aquamarine-environment-variables
...
-- hl.env('GTK_MODULES , colorreload) -- GTK2/3~4
