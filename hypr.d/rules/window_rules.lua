...
hl.windowrule('border_size 0,                                   match:workspace w[tv1]s[false],             match:float 0')
hl.windowrule('border_size 0,                                   match:workspace f[1]s[false],               match:float 0')
hl.windowrule('rounding 0,                                      match:workspace w[tv1]s[false],             match:float 0')
hl.windowrule('rounding 0,                                      match:workspace f[1]s[false],               match:float 0')
...
hl.windowrule('float on,                                        match:class ^(kitty)$,            match:title ^(kitty)$')
...
hl.windowrule([[float on,                    match:title                       ^([Pp]icture[-\s]?[Ii]n[-\s]?[Pp]icture)(.*)$]])
...
hl.windowrule([[keep_aspect_ratio on,        match:title                       ^([Pp]icture[-\s]?[Ii]n[-\s]?[Pp]icture)(.*)$]])
hl.windowrule('match:class ^()$,            match:title ^()$,                 no_blur on')
hl.windowrule('match:class .*,              no_blur on')
hl.windowrule([[match:class                  ^jetbrains-.*$,                   match:float 1,                                        match:title ^$|^\s$|^win\d+$,     no_initial_focus on]])
...
hl.windowrule('move                         (cursor_x-(window_w*0.5)) (cursor_y-(window_h*0.05)),         match:title ^(HyprEmoji)$')
...
hl.windowrule('opacity 1.0 override 1.0     override 1.0 override,                         match:class ^(UnrealEditor)$')
...
hl.windowrule('opaque on,                   match:class ^(.*)$,                            match:title ^(.*)$, match:content popup')
