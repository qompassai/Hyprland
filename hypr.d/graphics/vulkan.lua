...
-- /qompassai/hyprland/hypr/hypr.d/graphics/vulkan.conf
-- Qompass AI Hyprland Vulkan Config
-- Copyright (C) 2025 Qompass AI, All rights reserved
-- ###################################################
-- References: https://wiki.archlinux.org/title/Hardware_video_acceleration#Configuring_Vulkan_Video

hl.env('DISABLE_LAYER_AMD_SWITCHABLE_GRAPHICS_1', '1')
-- env = GDK_VULKAN_DISABLE                              , dmabuf,incremental-present,sempahore-export,sempahore-import,swapchain-maintenance,ycbr #GTK4
...
-- env = VK_ICD_FILENAMES                                , /home/pheadrus/.config/vulkan/icd.d/intel_icd.x86_64.jsonc:~/.config/vulkan/icd.d/nvidia_icd.jsonc
hl.env('VK_KHR_PRESENT_WAIT_ENABLED', '1')
-- env = __VK_LAYER_NV_optimus                           , NVIDIA_only
-- env = VK_LAYER_PATH                                   , /home/phaedrus/.config/vulkan/explicit_layer.d
...
-- env = MESA_VK_DEVICE_SELECT                           , pci:10de:2820
-- env = VK_INSTANCE_LAYERS                              , VK_LAYER_MESA_device_select
-- env = MANGOHUD                                        , 1
...
-- env = ENABLE_DEVICE_CHOOSER_LAYER                    , 1
-- env = ENABLE_PRIMUS_LAYER                            , 1
hl.env('OBS_VKCAPTURE', '1')
-- env = ENABLE_VKPOST                                  , 1
-- #######
-- env = MESA_VK_IGNORE_CONFORMANCE_BIT,1
-- env = VK_EXT_ray_tracing_server                       , 1
